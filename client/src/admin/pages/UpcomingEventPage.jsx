...
const UpcomingEventPage = () => {
    ...
    const handleAddSubmit = async (e) => {
        ...
        try {
            await apiClient.post(`${eventsApiUrl}/upload`, formData, {
                headers: { 'Content-Type': 'multipart/form-data' },
            });

            setFormSuccess('Upcoming event added successfully!');
            setImageFile(null);
            setImagePreviewUrl(null);
            setLink('');
            setDescription('');
            ...
            <div className={`container max-w-md md:max-w-xl lg:max-w-2xl mx-auto ${formCardBg} rounded-3xl shadow-xl ${neutralBorder} p-6 sm:p-8 lg:p-10 my-6 sm:my-8 z-10`}>
                <div className={`p-6 rounded-2xl ${neutralBorder} mb-8 ${innerFormSectionBg} transition duration-300 ease-in-out hover:shadow-lg`}>
                    ...
                    <form onSubmit={handleAddSubmit} className="space-y-6">
                        ...
                        <div>
                            <label htmlFor="link" className={`block ${generalDarkText} text-sm font-semibold mb-2 ${bodyFontClass}`}>
                                Event Link (Optional):
                            </label>
                            <input
                                type="text"
                        ...
                        <div>
                            <label htmlFor="registration" className={`block ${generalDarkText} text-sm font-semibold mb-2 ${bodyFontClass}`}>
                        ...
                        <div>
                            <label htmlFor="eventDate" className={`block ${generalDarkText} text-sm font-semibold mb-2 ${bodyFontClass}`}>
                                Event Date:
                            </label>
                            <input
                                type="date"
                ...
                <div className="text-center mt-8">
                    <Link
                        to="/admin/upcoming-events/manage"
